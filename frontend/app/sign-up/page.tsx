        ...
        <div className="relative z-10 bg-white rounded-[1.25rem] shadow-sm sm:px-10 px-8 py-10 border border-[#e5e7eb]">
          ...
          <div className="flex flex-col gap-3 mb-8">
            ...
            >
              ...
              <ArrowRight size={16} className="text-gray-400 opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-200" />
            </button>
            <button
              type="button"
          ...
          <form onSubmit={handleRegister}>
            <div className="mb-4">
              ...
              <input
                ...
                autoComplete="email"
                autoFocus
                className="w-full rounded-[6px] border border-[#d1d5db] px-3.5 py-[9px] text-[14px] text-gray-900 focus:outline-none focus:border-[#3b82f6] focus:ring-1 focus:ring-[#3b82f6] transition-shadow bg-white"
              />
            </div>
            ...
            <div className="mb-6 relative">
              ...
              <input
                ...
                className="w-full rounded-[6px] border border-[#d1d5db] px-3.5 py-[9px] pr-10 text-[14px] text-gray-900 focus:outline-none focus:border-[#3b82f6] focus:ring-1 focus:ring-[#3b82f6] transition-shadow bg-white"
              />
              <button
                type="button"
                onClick={() => setShowPass(!showPass)}
                className="absolute right-3 bottom-[9px] text-gray-400 hover:text-gray-600 transition-colors"
              >
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-[10px] rounded-[6px] font-bold text-[13px] tracking-[0.02em] text-white transition-all bg-[#0A0A0A] hover:bg-[#1f1f1f] disabled:opacity-60"
            >
          ...
          <div className="mt-8 text-[14px] text-gray-500">
            Have an account?{" "}
            <Link href="/sign-in" className="text-[#111827] font-medium hover:underline">
              Sign in
            </Link>
          </div>
        </div>
